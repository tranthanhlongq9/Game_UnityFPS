...
public class Player : MonoBehaviour {
	...
	//public int mapSo; //biến lưu số map
	...
	IEnumerator ShowDeadScreenAndCleanup() {
		...
		yield return new WaitForSeconds(10f);       // Đợi 10s để load lại game
		//SceneManager.LoadScene("Map1");
		SceneManager.LoadScene(SceneManager.GetActiveScene().name); //load lại map đang chơi
		//SceneManager.LoadScene(mapSo); //load lại map mà mình muốn bằng cách truyền số vào biến
	}
